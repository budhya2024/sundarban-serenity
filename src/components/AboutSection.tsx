        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div data-aos="fade-left" data-aos-duration="800">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              For over 15 years, Sundarban Bengal Trip has been the leading travel agency 
              specializing in expeditions to the magnificent Sundarbans. Our passion 
              for nature and commitment to sustainable tourism has made us the preferred 
              choice for wildlife enthusiasts and adventure seekers.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-8">
              From thrilling tiger spotting safaris to peaceful bird watching cruises, 
              we craft personalized experiences that connect you with the raw beauty 
