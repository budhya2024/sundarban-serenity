    ...
    <div className="fixed right-0 top-1/2 -translate-y-1/2 z-40 hidden lg:flex flex-col gap-1">
      {socialLinks.map((social) => (
        <a
          ...
          className={`w-12 h-12 flex items-center justify-center bg-primary text-primary-foreground transition-all duration-300 ${social.color}`}
        >
      ...
      <a
        ...
        rel="noopener noreferrer"
        aria-label="WhatsApp"
        className="w-12 h-12 flex items-center justify-center bg-primary text-primary-foreground transition-all duration-300 hover:bg-[#25D366]"
      >
