...
const highlights = [
  { id: 1, name: "Sajnekhali", description: "Wildlife Sanctuary & Watch Tower" },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12" data-aos="fade-up">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Discover the world's largest mangrove forest, just a few hours away from the City of Joy
          </p>
        </div>
          ...
          <div data-aos="fade-right">
            ...
            <div className="bg-card p-6 rounded-xl shadow-soft mb-8">
              ...
              <p className="text-muted-foreground mb-4">
                Start your adventure from Kolkata with our comfortable transport service. 
                Drive through the picturesque countryside of South 24 Parganas, crossing 
                rivers and villages, before reaching the gateway to Sundarbans.
              </p>
              <p className="text-muted-foreground mb-6">
                Our packages include pickup from Kolkata, all meals, boat safari, 
                forest permits, and experienced naturalist guides who bring the 
                wilderness to life.
              </p>
