...
export const BlogSidebar = ({ latestPosts, currentPostId }: BlogSidebarProps) => {
  const filteredPosts = latestPosts.filter((post) => post.id !== currentPostId).slice(0, 4);
  ...
  return (
    <aside className="space-y-8">
      ...
      {/* Tags */}
      <div className="bg-card rounded-2xl p-6 shadow-soft" data-aos="fade-left" data-aos-delay="100">
        <h3 className="font-display text-xl font-bold text-foreground mb-6 pb-3 border-b border-border">
          Popular Tags
        </h3>
      ...
      {/* Follow Us */}
      <div className="bg-card rounded-2xl p-6 shadow-soft" data-aos="fade-left" data-aos-delay="200">
        <h3 className="font-display text-xl font-bold text-foreground mb-6 pb-3 border-b border-border">
          Follow Us
        </h3>
