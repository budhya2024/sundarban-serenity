...
export const PopularPackagesSection = ({ currentPackageId }: PopularPackagesSectionProps) => {
  // Filter out the current package from the list
  const filteredPackages = popularPackages.filter(pkg => pkg.id !== currentPackageId);
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-border">
                  <div>
                    ...
                    <p className="font-display text-xl font-bold text-foreground">{pkg.price}</p>
                  </div>
