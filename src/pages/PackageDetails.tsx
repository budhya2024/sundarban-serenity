...
const packageData = {
  "day-trip": {
    ...
    image: tourBudget,
    description:
      "Sundarban day trip is the most familiar sundarban tour package now. Tourists are enjoying a lot in this package. But it is very top to cover all sightseeing. Some logical reason for Sundarban tour.",
    summary:
  ...
  weekend: {
    ...
    image: tourAdventure,
    description:
      "Sundarban tour 1 night 2 days is the most familiar sundarban tour package now. Tourists are enjoying a lot in this package. But it is very top to cover all sightseeing. Some logical reason for Sundarban tour.",
    summary:
