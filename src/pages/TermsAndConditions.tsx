      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div data-aos="fade-up" className="prose prose-lg max-w-none prose-headings:font-display prose-headings:text-foreground prose-p:text-muted-foreground">
            ...
            <p>By making a booking with Sundarban Tours, you agree to the following terms:</p>
            <ul>
              <li>A minimum deposit of 30% is required to confirm your booking</li>
              <li>Full payment must be received at least 7 days before the tour date</li>
            ...
            <h2>Liability</h2>
            <p>Sundarban Tours shall not be liable for:</p>
            <ul>
            ...
            <p>Wildlife sightings, including tigers, are not guaranteed. Nature is unpredictable, and we cannot control animal movements. No refunds will be provided for wildlife not spotted.</p>

            <h2>Photography</h2>
            <p>By joining our tours, you consent to being photographed for promotional purposes. If you prefer not to be photographed, please inform your guide at the start of the tour.</p>

            <h2>Governing Law</h2>
            <p>These terms shall be governed by the laws of India. Any disputes shall be subject to the exclusive jurisdiction of courts in Kolkata, West Bengal.</p>
